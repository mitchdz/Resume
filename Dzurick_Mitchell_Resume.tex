...
\section{EDUCATION} 
                ...
                \GPAindent GPA: \textbf{3.745}/4.00 \\
                {\sl Member} $\mid$ \textbf{Eta Kappa Nu IEEE}
                	\hfill Spring 2018 - Present \\
                \tab - Awarded to top 25\% of 2nd semester Sophomores. \\
                {\sl Dean's List} $\mid$ \textbf{University of Arizona College of Engineering} \hfill Fall 2016 - 2018 \\
...
\section{EXPERIENCE} 
				...
				\tab - Audit Security team for unit testing and code coverage. \\
				\tab - Integrate unit testing framework into legacy C library. \\
				\tab - Develop Yocto layer for application that will be ran on IOT devices.
												
				{\sl Student} $\mid$ \textbf{University of Arizona Computer Architecture}\hfill Fall 2018 \\
				%\begin{itemize}  \itemsep -2pt %reduce space between items
				\tab - Constructing general purpose pipe-lined processor that runs 32 bits MIPS. \\
